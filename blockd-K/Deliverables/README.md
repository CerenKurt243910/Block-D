# 📈 SmartPredict: Financial Forecasting for Competitive Trading

**Block 1D – 2024–2025**  
**Group 17**  
Zofia Pilitowska (240272)  
Ceren Kurt (243910)  
Filip Šarík (243537)  
Maks Burchard (240894)  
---
...
- Merge all time-series datasets using the `date` field
- Handle missing values using forward-fill and interpolation
- Standardize numerical features
- Engineer features: returns, moving averages, volatility, EPS surprises
...
- Time-aware validation (train on past, test on future)
...
```bash
git clone https://github.com/BredaUniversityADSAI/2024-25-y1d-teamwork-group-17.git
